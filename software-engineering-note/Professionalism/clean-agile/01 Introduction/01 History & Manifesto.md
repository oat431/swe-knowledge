...
Waterfall dominated from the 1970s for nearly 30 years. Three equal phases: analysis → design → implementation.

| Phase | What Happened | Problem |
|-------|--------------|---------|
| Analysis | Gather requirements, plan | No tangible output. "Done when time's up." |
...
The 12 Principles were written collaboratively in the two weeks following the conference. They explain and direct the four values.

---

## Key Insight

Agile is not a process. It's not Scrum. It's not SAFe. It's a set of **values, rights, expectations, and disciplines** that form the basis for an ethical profession. The original signatories: Beck, Martin, Cunningham (XP), Schwaber, Beedle, Sutherland (Scrum), Hunt, Thomas (Pragmatic Programmers), and others.
