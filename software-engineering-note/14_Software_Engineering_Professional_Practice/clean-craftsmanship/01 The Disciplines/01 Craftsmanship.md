...
## Extreme Programming & The Circle of Life

Craftsmanship is rooted in Extreme Programming (XP). The Circle of Life organizes XP's practices:

```
Outer Ring (Business):  Planning Game, Small Releases, Acceptance Tests, Whole Team
Middle Ring (Team):     Sustainable Pace, Collective Ownership, CI, Metaphor
Inner Ring (Technical):  TDD, Refactoring, Simple Design, Pair Programming
```

> Without the inner ring (technical practices), the outer rings become a mess-making machine. The disciplines of the inner ring are what make everything else work.
...
- Martin, Robert C. *Clean Craftsmanship*, Chapter 1.
