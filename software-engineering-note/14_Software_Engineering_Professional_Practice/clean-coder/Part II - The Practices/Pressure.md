...
> *Source: The Clean Coder by Robert C. Martin, Chapter 11 (pp. 149–155)*
...
Imagine you're on the operating table. How do you want the surgeon to behave? Calm, collected, issuing clear orders, following training and discipline? Or sweating, swearing, slamming instruments, blaming management, complaining about time?
...
The best way to stay calm under pressure is to avoid the situations that cause it. Avoidance won't eliminate pressure entirely, but it minimizes and shortens the high-pressure periods.

### 1. Manage Commitments

Don't commit to deadlines you aren't sure you can meet. The business always wants firm commitments because they want to eliminate risk. Your job is to **quantify the risk** and present it so the business can manage it appropriately. Accepting unrealistic commitments does a disservice to both sides.

When the business makes promises to customers without consulting you:
- You are **honor bound to help** the business find a way to meet those commitments
...
The way to go fast and keep deadlines at bay is to stay clean. Professionals do not succumb to the temptation to create a mess in order to move quickly.
...
Sometimes pressure comes despite your best efforts. The project takes longer than expected. The initial design is wrong. You lose a key team member. You make a commitment you just can't keep. Then what?

### 1. Don't Panic

Manage your stress. Sleepless nights, fretting, and rushing won't help. **Rushing will only drive you deeper into the hole.** Instead, slow down. Think the problem through. Plot a course to the best possible outcome, then drive toward it at a reasonable and steady pace.
...
Your disciplines exist to guide you through high-pressure times. A crisis reveals what you truly believe:

- If you follow TDD normally but abandon it in a crisis, you don't really trust that TDD helps.
...
**Pair.** When the heat is on, find an associate willing to pair with you. You'll get done faster with fewer defects. Your pair partner will:
- Help you hold onto your disciplines
- Keep you from panicking
- Spot things you miss
- Have helpful ideas
- Pick up the slack when you lose focus

By the same token, when you see someone else under pressure, offer to pair with them. Help them out of the hole.
