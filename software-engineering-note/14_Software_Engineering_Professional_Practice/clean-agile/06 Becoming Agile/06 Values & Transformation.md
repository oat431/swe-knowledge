...
## Kent Beck's Four Agile Values

| Value | What It Means |
|-------|--------------|
| **Courage** | Don't sacrifice quality for political safety. Maintaining high quality and discipline takes courage. Recklessness is not courage. |
| **Communication** | Value informal communication within the team and with stakeholders. It helps teams grow together. |
| **Feedback** | All Agile practices provide rapid feedback. Detect when things go wrong early. Confront consequences of earlier decisions. |
| **Simplicity** | Being simple is being direct. Reduce indirection in code to a sustainable level. **Eliminate indirection in personal communication completely.** |

### Indirection is the Enemy

| In Code | In Communication |
|---------|-----------------|
| Extra layers of abstraction | Passive aggression |
| Over-engineering | Grudgingly acceding to unreasonable demands |
| Premature generalization | Postponing conflicts instead of openly opposing them |
...
| Role | Why |
|------|-----|
| **Executives** | Risk-takers who seek new opportunities. Tend to be supportive. |
...
Large organizations don't adopt Agile wholesale. They create **new, smaller organizations** based on Agile values. Eventually those thrive and grow out of the parent company.
