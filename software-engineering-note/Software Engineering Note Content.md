...
> **Source:** SWEBOK v4 (IEEE Computer Society, 2024) — 18 Knowledge Areas
> Organized by the standard SDLC phases: Requirements → Architecture → Design → Construction → Testing → Deployment/Operations → Maintenance
> Plus cross-cutting documents that span multiple phases (Management, Quality, Security, SCM)
...
| **SBOM** (Software Bill of Materials) | Component inventory with versions and supply-chain data | 🔴 Must Have | ISO/IEC 5230 (OpenChain), SPDX |
...
Per SWEBOK v4 [[10_Software_Engineering_Process]], the six generic life cycle stages are:
