...
- [ ] JSON-LD validates in Google Rich Results Test (if structured data used)
...
| 3 | Rendering Strategy | 🟡 static only | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
...
| 17 | Internationalization | ❌ | 🟡 externalize strings | 🟡 if multi-lang | 🟡 if multi-lang | ✅ if multi-lang | ✅ | ✅ |
| 18 | Offline & Resilience | ❌ | ❌ | 🟡 if needed | 🟡 graceful degrade | ✅ if PWA | ✅ | ✅ |
| 19 | AI/LLM Integration | 🟡 if AI is the POC | 🟡 | 🟡 if used | ✅ if used | ✅ | ✅ + guardrails | ✅ + audit trail |
| 20 | Data Privacy & Compliance | ❌ | ❌ | 🟡 minimal | ✅ consent + PII | ✅ + DPA | ✅ full compliance | ✅ + regulatory framework |
