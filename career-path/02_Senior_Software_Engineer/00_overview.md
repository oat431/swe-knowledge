...
| Requirements and problem framing | Clarifies the underlying problem and acceptance conditions | [[02_Problem_Framing_and_Requirements/00_overview|Problem Framing and Requirements]] |
...
```mermaid
flowchart LR
    ENGINEER["Software Engineer"] --> OWNER["Own a subsystem"]
    OWNER --> JUDGE["Make technical and delivery judgments"]
    JUDGE --> MULTIPLY["Multiply team effectiveness"]
    MULTIPLY --> NEXT["Choose staff, lead, manager, delivery, or product path"]
```
...
- [[career-path/03_Staff_Engineer/00_overview|Staff Engineer]]: broader influence across teams while remaining an individual contributor
- [[career-path/05_Tech_Lead/00_overview|Tech Lead]]: direct technical coordination for a team or system
- [[career-path/06_Software_Architect/00_overview|Software Architect]]: explicit focus on system structure and architecture decisions
- [[career-path/11_Engineering_Manager/00_overview|Engineering Manager]]: focus on people, team health, and delivery conditions
- [[career-path/12_Technical_Program_Manager/00_overview|Technical Program Manager]]: focus on cross-team technical initiatives
- [[career-path/14_Product_Manager/00_overview|Product Manager]]: focus on product value, customer problems, and outcome direction

## Suggested Future Note Route

1. [[software-engineering-note/01_Software_Requirements/Software Requirements Overview]]
2. [[software-engineering-note/02_Software_Architecture/Software Architecture Overview]]
3. [[software-engineering-note/03_Software_Design/Software Design Note Overview]]
4. [[software-engineering-note/06_Software_Engineering_Operations/Software Engineering Operations Overview]]
5. [[software-engineering-note/09_Software_Engineering_Management/Software Engineering Management Overview]]
6. [[software-engineering-note/12_Software_Quality/Software Quality Overview]]
