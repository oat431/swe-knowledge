---
title: "Solutions and Enterprise Architect"
...
```mermaid
flowchart LR
    ARCH["Software Architect"] --> SOLUTION["Shape one complex solution"]
    SOLUTION --> DOMAIN["Lead architecture across a domain"]
    DOMAIN --> ENTERPRISE["Shape enterprise architecture"]
    ENTERPRISE --> TRANSFORM["Lead business and technology transformation"]
```
